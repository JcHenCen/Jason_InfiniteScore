...
abstract class BaseFragment(@LayoutRes private val layout: Int, private val lazyInit:Boolean = false) : Fragment(layout) {
    ...
    private fun _initData() = lifecycleScope.launch {
     ...
     * fragment跳转，防止重复点击崩溃
     */
    fun navigate(destination: Int, bundle: Bundle ?= null) = lifecycleScope.launch(Dispatchers.Main){
        NavHostFragment.findNavController(this@BaseFragment).apply {
